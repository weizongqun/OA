...
$(document).ready(function(){
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"uname",sortable:true},{text:"申请人部门",dataIndex:"udeptname",sortable:true},{text:"职位",dataIndex:"ranking",sortable:true},{text:"申请日期",dataIndex:"applydt",sortable:true},{text:"入职日期",dataIndex:"entrydt"},{text:"离职类型",dataIndex:"redundtype",sortable:true},{text:"离职日期",dataIndex:"quitdt",sortable:true},{text:"离职原因",dataIndex:"redundreson",sortable:true},{text:"说明",dataIndex:"explain",sortable:true},{text:"状态",dataIndex:"statustext"},{
