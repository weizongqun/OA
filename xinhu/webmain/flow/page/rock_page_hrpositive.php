...
$(document).ready(function(){
	...
	var fieldsarr = [{"fields":"uname","name":"\u7533\u8bf7\u4eba","fieldstype":"text","ispx":"1","isalign":"0","islb":"1"},{"fields":"udeptname","name":"\u7533\u8bf7\u4eba\u90e8\u95e8","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"applydt","name":"\u7533\u8bf7\u65e5\u671f","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"ranking","name":"\u804c\u4f4d","fieldstype":"text","ispx":"0","isalign":"0","islb":"1"},{"fields":"entrydt","name":"\u5165\u804c\u65e5\u671f","fieldstype":"text","ispx":"1","isalign":"0","islb":"1"},{"fields":"syenddt","name":"\u8bd5\u7528\u5230\u671f\u65e5","fieldstype":"date","ispx":"0","isalign":"0","islb":"1"},{"fields":"positivedt","name":"\u8f6c\u6b63\u65e5\u671f","fieldstype":"date","ispx":"1","isalign":"0","islb":"1"},{"fields":"explain","name":"\u7533\u8bf7\u8bf4\u660e","fieldstype":"textarea","ispx":"0","isalign":"0","islb":"1"}],fieldsselarr= {"columns_hrpositive_all":"uname,udeptname,applydt,ranking,entrydt,syenddt,positivedt,explain,caozuo"};
	...
	var bootparams = {
		...
		params:{atype:atype},
		columns:[{text:"申请人",dataIndex:"uname",sortable:true},{text:"申请人部门",dataIndex:"udeptname"},{text:"申请日期",dataIndex:"applydt",sortable:true},{text:"职位",dataIndex:"ranking"},{text:"入职日期",dataIndex:"entrydt",sortable:true},{text:"试用到期日",dataIndex:"syenddt"},{text:"转正日期",dataIndex:"positivedt",sortable:true},{text:"申请说明",dataIndex:"explain"},{text:"状态",dataIndex:"statustext"},{
